...
class Admin {
	...
	public function add_lw_shortcode_form( $column, $post_id ) {
		...
		switch ( $column ) {
			...
			case 'shortcode':
				$column_field = '<div class="splw-after-copy-text"><i class="fa fa-check-circle"></i>  Shortcode  Copied to Clipboard! </div><input class="splw__shortcode" style="width:205px;padding:6px;text-align:left;padding-left:15px;cursor:pointer;" type="text" onClick="this.select();" readonly="readonly" value="[location-weather ' . 'id=&quot;' . $post_id . '&quot;' . ']"/>';
				echo $column_field;
				break;
			default:
				break;
