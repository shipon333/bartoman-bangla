...
if ( ! class_exists( 'SPLWT_Field_wp_editor' ) ) {
	class SPLWT_Field_wp_editor extends SPLWT_Fields {
		...
		public function render() {
			...
			echo ( splwt_wp_editor_api() ) ? '<div class="splwt-lite-wp-editor" data-editor-settings="' . esc_attr( json_encode( $editor_settings ) ) . '">' : '';
		...
		public function setup_wp_editor_media_buttons() {
			...
			echo 'var splwt_media_buttons = ' . json_encode( $media_buttons ) . ';';
			echo '</script>';
