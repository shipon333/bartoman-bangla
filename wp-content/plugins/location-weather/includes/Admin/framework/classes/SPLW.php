<?php
// namespace ShapedPlugin\Weather\Admin\Framework\Classes;
	...
	class SPLW {
		...
		public static function add_typography_enqueue_styles() {
			...
			if ( ! empty( self::$webfonts ) ) {
				...
				if ( ! empty( self::$webfonts['enqueue'] ) ) {
					...
					wp_enqueue_script( 'splwt-lite-google-web-fonts', esc_url( '//ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js' ), array(), null );
		...
		public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
			...
			if ( ! empty( $field_type ) ) {
				...
				echo '<div class="splwt-lite-field splwt-lite-field-' . $field_type . $is_pseudo . $class . $visible . '"' . $depend . '>';
